  ...
  return (
    <>
      <div className="flex items-center justify-center">
        <h1 className="lg:text-2xl text-base sm:text-lg font-bold text-indigo-500">
          Search Employee
        </h1>
      </div>
      <form
      ...
      <div className="overflow-scroll h-[350px] w-full rounded-lg border border-gray-200 shadow-md mt-4">
